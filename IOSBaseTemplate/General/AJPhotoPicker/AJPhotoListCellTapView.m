...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _selectIcon = [[UIImageView alloc] initWithFrame:CGRectMake(frame.size.width - checkedIcon.size.width - _size_H_S_X(5), _size_H_S_X(5), checkedIcon.size.width, checkedIcon.size.height)];
