...
@implementation NSObject (WYComponentTableCategory)
...
@implementation UIView (WYComponentTableCategory)
...
@implementation NSAttributedString (WYComponentTableCategory)
...
@implementation NSString (WYComponentTableCategory)
...
@implementation UILabel (WYComponentTableCategory)
