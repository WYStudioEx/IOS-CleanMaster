...
@interface NSObject (WYComponentTableCategory)
...
@interface UIView (WYComponentTableCategory)
...
@interface NSString (WYComponentTableCategory)
...
@interface UILabel (WYComponentTableCategory)
...
@interface NSAttributedString (WYComponentTableCategory)
